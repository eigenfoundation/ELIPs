...
When a slashing occurs, an event is emitted onchain. The granularity of this event is at the `(Strategy, Operator, Operator Set)` level, with more fields for the amount and meta-data:
```
