...
Deregistration can be used to signal an exit from an Operator Set, or for other cases like signaling a period of Operator inactivity or an inability to receive tasks. Deregistration is subject to a delay to ensure slashing can occur in case of fault during an exit. Funds can be made non-slashable through other pathways that don’t involve deregistration, like [deallocation](./ELIP-002.md#allocating-and-deallocating-to-operator-sets). 
